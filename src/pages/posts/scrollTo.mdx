...
I wanted to share a solution for scrolling the window down to a certain element on click. I discovered this solution while building a passion project called UI Gems.
...
<img
  ...
  src="https://drive.google.com/uc?id=1U_5xsn_hCAlBJulUEbs6Ib0-yzgYoKO2"
/>
...
<img
  ...
  src="https://drive.google.com/uc?id=1bmj3w3O57uHQBDdprGBv2z0QYOkhtr-H"
/>
...
<img
  style="margin: 0px 0px 20px"
  src="https://drive.google.com/uc?id=1ajtn2M6_lqhCIThptX-Zoxwx-saLCB4a"
/>
...
Next, we need to know the target's location in the DOM, in pixels. Luckily we have another handy method which we can use to grab that.
