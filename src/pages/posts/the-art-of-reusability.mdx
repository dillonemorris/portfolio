...
For a more in-depth tutorial of that process you can check out the step by step guide <a href="https://www.netlify.com/blog/2016/02/24/a-step-by-step-guide-gatsby-on-netlify/" target="_blank" rel="noopener noreferrer">here</a>, but that's pretty much it
...
```js
<Button text={'back to writing'} fontSize={14} page={'/blog/'} />
```
